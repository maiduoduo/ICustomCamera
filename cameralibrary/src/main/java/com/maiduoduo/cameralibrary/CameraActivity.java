package com.maiduoduo.cameralibrary;
...
import com.maiduoduo.cameralibrary.utils.SystemUtils;
...
public class CameraActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private ImageView btn_close,btn_change;
...
//    private double defaultProportion = 1.56;
    private double defaultProportion = 0.86;
...
//        rectangleH = 950;
        ...
        Log.e(TAG, "rectangleW:" + rectangleW + ",rectangleH:" + rectangleH);
...
//                saveBitmap = Bitmap.createScaledBitmap(saveBitmap, screenWidth, picHeight, true);
                saveBitmap = Bitmap.createScaledBitmap(saveBitmap, screenWidth, screenHeight-300, true);
                ...
                Log.e(TAG, "onPictureTaken-----bitmapWidth==" + bitmap.getWidth() + "");
                Log.e(TAG, "onPictureTaken-----bitmapHeight==" + bitmap.getHeight() + "");
                Log.e(TAG, "onPictureTaken-----saveBitmapWidth==" + saveBitmap.getWidth() + "");
                Log.e(TAG, "onPictureTaken-----saveBitmapHeight==" + saveBitmap.getHeight() + "");
                ...
                Log.e(TAG, "imageX:" + imageX + ",imageY:" + imageY + ",imageW:" + imageW + ",imageH:" + imageH);

                saveBitmap = Bitmap.createBitmap(saveBitmap, (int) imageX, (int) imageY, (int) imageW, (int) imageH);

                String img_path = getAlbumStorageDir("MNCustomCamera")+String.format("mnCamera_%d.jpeg", System.currentTimeMillis());
...
//                mCamera.autoFocus(CameraManager.get().getAutoFocusCallback());
